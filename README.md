...
Hosting live at: [headless.builders](https://headless.builders/)
...
- [Getting Started](#getting-started)
  ...
  - [4.  VINCHDE private app](#4-shopify-private-app)
  - [5. Connecting Builder to  VINCHDE](#5-connecting-builder-to-shopify)
  - [6. Configure the project to talk to  VINCHDE](#6-configure-the-project-to-talk-to-shopify)
